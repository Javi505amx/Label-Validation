    ...
    public partial class Validation : System.Web.UI.Page
    {
        ...
        protected void txtWorkOrder_TextChanged(object sender, EventArgs e)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                ...
                lblQtyPartNumbers.Text = Convert.ToString(cmdQty.ExecuteScalar());
                connectionQty.Close();
            }
            else
            {
        ...
        protected void txtPartNumber_TextChanged(object sender, EventArgs e)
        {
            ...
            if (drPartNumber.HasRows)
            {
                ...
                SqlCommand cmd = new SqlCommand("AddValidationMaterialValidation", sqlConnection)
                {
                    CommandType = CommandType.StoredProcedure
                };
                cmd.Connection.Open();
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            lblModel.Text = "";
            lblPNTitle.Text = "";
            lblQtyPartNumbers.Visible = false;
            lblPNName.Visible = false;
            lblPNName.Text = "";
            lblResultQty.Visible = false;
            lblResultQty.Text = "";
            lblResult.Text = "";
