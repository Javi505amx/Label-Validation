<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ejemplo.test" %>
...
<body class="bg-light" onload="noBack()">
    <div class="container">
        <div>
            <div>
                <br />
                ...
                <form id="frmLogin" runat="server" style="font-family:Calibri">
                    <div>
                        <div id="divTitle">
                            <asp:Label ID="lblWelcome" runat="server" Text="LABEL VALIDATION" Font-Bold="true" Font-Size="250%" style="text-align:center" ForeColor="#000099"></asp:Label>
                        </div>
                        <br />
                        <br />
                        <div>
                            <asp:Label ID="lblUser" runat="server" Text="Usuario:" Font-Size="150%"></asp:Label><br /><!--OnTextChanged="txtUser_TextChanged"-->
                        ...
                        <br />
                        <div> 
                            <asp:Button ID="btnLogin" CssClass="btn-dark" runat="server" Text="Login"  Font-Size="150%" Height="50px" Width="300px" OnClick="btnLogin_Click"/>
                        </div>
                    </div>
                </form>
            </div>
